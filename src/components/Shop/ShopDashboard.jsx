        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <p className="text-sm text-gray-500">Available Knives</p>
              <p className="text-2xl font-bold text-ss_purple">{knives.length}</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
            ...
            >
              <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                ...
                {hoveredKnife?.id === knife.id && (
                  <div className="absolute bottom-4 right-4 bg-white border-2 border-ss_purple rounded-lg shadow-lg p-3 z-10 min-w-48">
        ...
        {knives.length === 0 && (
          <div className="text-center py-12">
            <p className="text-gray-500 text-lg">No knives available at the moment</p>
          </div>
        )}
      </main>
    </div>
